...
from models.farm import Zone, Acre, Farm
from schemas.ai import PredictionResponse, CropPlanResponse, AiValidationLogResponse, PredictionCreate, CropPlanCreate
