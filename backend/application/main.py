...
# Import all routers
from routes import sensor, irrigation, command, farm, auth, analytics, ai, chat, notification, report, utility, web
from routes import websocket_routes
import models  # This correctly triggers SQLAlchemy metadata registry
