...
from application.schemas.chat import ChatRequest, ChatLogCreate, ChatLogResponse, MessageTemplateResponse
from application.services import chat_service
...
async def save_chat_message(data: ChatRequest, db: Session = Depends(get_db)):
    ...
    # 6. Log to DB
    return chat_service.log_chat_interaction(db, log_data)
